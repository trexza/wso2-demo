...
import com.trexza.springboot.rest.service.PersonService;
...
public class PersonEndpoint extends BaseEndpoint {
    ...
    public String clientAccess() {
        ...
        resource.setAccessTokenUri("https://localhost:8244/token");
        resource.setClientId("FFuZejzu2YBqWnnr1ay93OrvF6wa");
        //resource.setId("sparklr");
        resource.setClientSecret("7i1iR16PdeZS_K1I1ZhQmfn0JIMa");
        ...
        String result = template.getForObject("https://localhost:8244/restapi/1.0/txa/employees", String.class);
        return result;
